  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4">
      <div className="py-8 bg-gray-200 rounded-3xl shadow-lg overflow-hidden">
        ...
        <div className="grid grid-cols-12 gap-10 justify-items-center items-center px-4 md:px-8">
          {categories.map((category, index) => (
            <div
              key={index}
              className={`relative col-span-12 ${
                index % 2 === 0 ? "md:col-span-4" : "md:col-span-8"
              } rounded-2xl bg-cover bg-center h-[350px] w-full shadow-md transition-transform md:hover:scale-105 duration-400`}
